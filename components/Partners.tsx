...
const Partners = () => {
  const logos = [
    {
      src: '/images/msi-partners/msi_partner_barloworld-logo.png',
      alt: 'Barloworld',
      width: 200,
      url: 'https://www.barloworld.com'
    },
    {
      src: '/images/msi-partners/msi_partner_eastern_cape.svg',
      alt: 'Eastern Cape Education',
      width: 200,
      url: 'https://eceducation.gov.za/'
    },
    {
      src: '/images/msi-partners/msi_partner_standard_bank_logo.svg',
      alt: 'Standard Bank',
      width: 200,
      url: 'https://www.standardbank.co.za'
    },
    {
      src: '/images/msi-partners/msi_partner_university_of_fort_hare.png',
      alt: 'University of Fort Hare',
      width: 200,
      url: 'https://www.ufh.ac.za/'
    },
    {
      src: '/images/msi-partners/msi_partner_grindrod-logo-color.svg',
      alt: 'Grindrod',
      width: 200,
      url: 'https://www.grindrod.com/'
    },
    {
      src: '/images/msi-partners/msi_partner_adopt_a_school.svg',
      alt: 'Adopt a School Foundation',
      width: 240,
      url: 'https://www.adoptaschool.org.za/'
    },
    {
      src: '/images/msi-partners/msi_partners_Zenex.png',
      alt: 'Zenex Foundation',
      width: 200,
      url: 'https://www.zenexfoundation.org.za/'
    },
    {
      src: '/images/msi-partners/msi_patner_idc.png',
      alt: 'Industrial Development Corporation',
      width: 200,
      url: 'https://www.idc.co.za/'
    },
    {
      src: '/images/msi-partners/msi_partner_cwn.jpg',
      alt: 'CWN',
      width: 200,
      url: ''
    },
    {
      src: '/images/msi-partners/msi_partner_nedbank.svg',
      alt: 'Nedbank',
      width: 200,
      url: 'https://personal.nedbank.co.za/home.html'
    },
    {
      src: '/images/msi-partners/msi_partner_limbe.jpg',
      alt: 'Limbe Energy',
      width: 200,
      url: 'https://www.facebook.com/limbeenergy/'
    },
    {
      src: '/images/msi-partners/msi_partner_RAF-logo.jpg',
      alt: 'Road Accident Fund',
      width: 200,
      url: 'https://www.raf.co.za/Pages/Default.aspx'
    },
    {
      src: '/images/msi-partners/msi_partner_sapco.jpg',
      alt: 'SA Public Colleges Organisation',
      width: 200,
      url: 'https://sacpo.co.za/'
    },
    {
      src: '/images/msi-partners/msi_partners_DHET.png',
      alt: 'Department of Higher Education and Training',
      width: 200,
      url: 'https://www.dhet.gov.za/'
    },
    {
      src: '/images/msi-partners/msi_partner_dbe.png',
      alt: 'Department of Basic Education',
      width: 200,
      url: 'https://www.education.gov.za/'
    },
    {
      src: '/images/msi-partners/msi_partner_airlink-logo.svg',
      alt: 'Airlink',
      width: 200,
